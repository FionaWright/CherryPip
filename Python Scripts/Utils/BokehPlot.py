...
def plot_histogram(x_data: list[float], y_data: list[float], num_bins: int, name: str, show_plot: bool, save_plot: bool):
    """
    ...
    """
    hist, edges = np.histogram(x_data, bins=num_bins, weights=y_data)
